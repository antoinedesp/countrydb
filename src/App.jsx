...
function App() {
  ...
  const [isViewingingDetailCountry, setIsViewingDetailCountry] = useState(false);
  const [viewDetailCountry, setViewDetailCountry] = useState(null);
  ...
  const onCountryClick = (country) => {
    setViewDetailCountry(country);
    setIsViewingDetailCountry(true);
  }
  ...
  const handleCloseDetailCountry = () => {
    setIsViewingDetailCountry(false);
    setViewDetailCountry(null);
  }
    ...
    <div className={ theme == 'light' ? 'w-full bg-slate-50' : 'w-full bg-slate-900' }>
      ...
      </div>
      {
        isCountryListLoaded ? 
          ...
          isViewingingDetailCountry ?

            <CountryDetailView theme={theme} country={viewDetailCountry} onClose={handleCloseDetailCountry} />
            ...
            : (
                <>
                  ...
                  <CountryFlexList theme={theme} onCountryClick={onCountryClick} countries={viewableCountries}/>
                </>
            )
